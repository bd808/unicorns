...
<?php startblock('title-full'); ?>UNICORNS!!<?php endblock('title-full'); ?>
<?php startblock('content'); ?>
<div class="hero-unit">
  <h1>Unicorns are awesome!</h1>
  <div class="row">
    <div class="span6">
      <p><img src="img/0001.jpg" width="330"/></p>
    </div>
    <div class="span8">
      <p>Unicorns are the most amazing mythical creatures ever imagined. People all over the world love unicorns and want to know everything there is to know about them. Our image will show you how beautiful unicorns look and the other pages will tell you what they eat, how they reproduce, and many other pieces of interesting information.</p>
    </div>
  </div>
</div>
<div class="row">
